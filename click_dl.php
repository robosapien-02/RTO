				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.html">Regional Transport Office</span></a></h1>
							</div>
						</div>
			...
			<div class="footer-w3">
				<div class="container">
                  ...
                  It also is responsible to inspect vehicle's insurance and clear the pollution test.</span></p>
						...
						<h4>Information</h4>
							<ul>
								<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Indore</li>
								<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>9893436612</li>
								<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:akhileshdhakre123@gmail.com.com"> Indore@rto.com</a></li>
